...
const PRODUCTS = [
  ...
  { id: 5, name: 'Dragon Egg Twist Fidget', basePrice: 15, salePrice: null, tag: 'New Arrival', images: ['/dragon egg.webp'], description: 'A satisfying articulated dragon egg fidget toy. Each scale moves independently.', credit: 'Design: Dragon Egg Twist Fidget by nixkor, Licensed under CC BY-SA 4.0. Printed by D3V Prints.'},
  { id: 6, name: 'Custom Print',            basePrice: 0,  salePrice: null, tag: 'Any Design',   images: ['/custom12.jpg','/custom11.webp','/gpusupport.png'],    description: 'Have a design in mind? Send us your STL file and we will print it for you. Any color, any material.', isCustom: true, credit: null },
] as const;
