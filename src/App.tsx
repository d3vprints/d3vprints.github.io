...
const PRODUCTS = [
  ...
  { id: 5, name: 'Custom Print',            basePrice: 0,  salePrice: null, tag: 'Any Design',   images: ['/custom12.jpg','/custom11.webp'],    description: 'Have a design in mind? Send us your STL file and we will print it for you. Any color, any material.', isCustom: true, credit: null },
] as const;
