...
const PRODUCTS = [
  ...
  { id: 5, name: 'Dragon Egg Twist Fidget', basePrice: 20, salePrice: 12, tag: 'New Arrival', images: ['/dragon egg.webp'], description: 'A satisfying articulated dragon egg fidget toy. Each scale moves independently.', credit: 'Design: Dragon Egg Twist Fidget by nixkor, Licensed under CC BY-SA 4.0. Printed by D3V Prints.'},
